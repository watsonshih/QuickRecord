const languages = {
    'zh-TW': {
        ...
        footerGuide: '使用指南',
        footerTerms: '服務條款',
        csvPreviewTitle: 'CSV 資料預覽與驗證',
        dataValidationIssues: '資料驗證問題：',
        fieldMapping: '欄位對應',
        totalRows: '總計',
        rows: '行',
        validRows: '有效',
        invalidRows: '無效',
        importValidData: '匯入有效資料',
        duplicateIdWarning: '重複的 ID',
    ...
    'en': {
        ...
        csvPreviewTitle: 'CSV Data Preview and Validation',
        ...
        validRows: 'Valid',
        invalidRows: 'Invalid',
        importValidData: 'Import Valid Data',
        duplicateIdWarning: 'Duplicate ID',

const languages = {
    'zh-TW': {
        newCheckIn: '開始新的簽到',
        newCheckInDesc: '建立一個全新的簽到活動，稍後可手動輸入參與者。',
        startDirectly: '直接開始',
        dropCSV: '預先匯入參與名單',
        dropCSVDesc: '使用 CSV 匯入參與者名單，可直接拖拽檔案於此。',
        selectCSVFile: '選擇 CSV 檔案',
        confirmImport: '確認匯入',
        ...
        rowLabel: '行',
        statusLabel: '狀態',
        missingFieldWarning: '行 {0}: 缺少必要欄位 (Name 或 ID)',
        duplicateIdWarning: '行 {0}: 重複的 ID "{1}"',
        nameFieldLabel: 'Name 欄位',
        idFieldLabel: 'ID 欄位',
        noteFieldLabel: 'Note 欄位 (選填)',
    },
    'en': {
        newCheckIn: 'Start New Check-in',
        newCheckInDesc: 'Create a new check-in event, participants can be added manually later.',
        startDirectly: 'Start Directly',
        dropCSV: 'Import participant list',
        dropCSVDesc: 'Import participant list using CSV, or drag and drop file here.',
        ...
        rowLabel: 'Row',
        statusLabel: 'Status',
        missingFieldWarning: 'Row {0}: Missing required fields (Name or ID)',
        duplicateIdWarning: 'Row {0}: Duplicate ID "{1}"',
        nameFieldLabel: 'Name Field',
        idFieldLabel: 'ID Field',
        noteFieldLabel: 'Note Field (Optional)',
    }
};
